# StoryArcPlotter.py - Generates graphs based on the happiness of a shakespeare play per line.
# Copyright (C) 2018 Rory Brown <rorybrown660@gmail.com>
#
...
#
# This program makes use of the AFINN sentiment dataset by Finn Årup Nielsen, under the "Open Database License (ODbL) v1.0"<http://www.opendatacommons.org/licenses/odbl/1.0/>.
